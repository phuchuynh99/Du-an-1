                    ...
                    <div class="col-6 col-md-6 col-lg-3 mb-4">
                        <div class="product-card">
                            <?php if ($related['discount_price'] > 0): ?>
                                <div class="discount-tag">-<?= round((1 - $related['discount_price'] / $related['price']) * 100) ?>%</div>
                            <?php endif; ?>
                            <img src="public/img/<?= $related['img'] ?>" alt="<?= $related['name'] ?>" class="product-image">
                            <p class="product-title-similar"><?= $related['name'] ?></p>
                            <p>
                                <?php if ($related['discount_price'] > 0): ?>
                                    <span class="product-price-old-similar"><?= number_format($related['price'], 0, ',', '.') ?>đ</span>
                                    <span class="product-price-similar"><?= number_format($related['discount_price'], 0, ',', '.') ?>đ</span>
                                <?php else: ?>
                                    <span class="product-price-similar"><?= number_format($related['price'], 0, ',', '.') ?>đ</span>
                                <?php endif; ?>
                            </p>
